describe Strongman do
  ...
  it "supports loading out of order when chaining" do
    ...
    data_transformer = data_loader.depends_on do |parent, ids|
  ...
  it "can resolve in complex cases" do
    ...
    loader2 = loader.depends_on(name: "loader 2") do |parent, ids|
    ...
    loader3 = loader2.depends_on(name: "loader 3") do |parent, ids|
